...
public class Them_TK extends javax.swing.JFrame {
    ...
    private void LuuBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LuuBtnActionPerformed
        ...
        if(HoTen_txt.getText().isEmpty() || gmail_txt.getText().isEmpty() || SDT_txt.getText().isEmpty() || DC_txt.getText().isEmpty() || CV_txt.getText().isEmpty() || Luong_txt.getText().isEmpty() || NgaySinh.isEmpty() || NgayTaoTK.isEmpty() || TDN_txt.getText().isEmpty() || MK_txt.getText().isEmpty())
        {
        ...
        if (opt == JOptionPane.YES_OPTION) {
            TaiKhoanModel tkm = new TaiKhoanModel(Long.parseLong(Luong_txt.getText()), TDN_txt.getText(), MK_txt.getText(), HoTen_txt.getText(), DC_txt.getText(), SDT_txt.getText(), gmail_txt.getText(), CV_txt.getText(), NgSinhLC, NgTaoLC);
            if(tk.ThemTK(tkm) != 0){
