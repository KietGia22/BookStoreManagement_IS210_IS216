 ...
 * @author GIA KIET
 */
public class KhongHien extends javax.swing.JFrame {

    /**
     * Creates new form KhongHien
     */
    public KhongHien() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bạn không có quyền sử dụng tính năng này");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KhongHien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
