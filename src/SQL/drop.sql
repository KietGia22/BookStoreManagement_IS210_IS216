...
ALTER TABLE PHIEUNHAPSACH DROP CONSTRAINT FK_PN1;
ALTER TABLE PHIEUNHAPSACH DROP CONSTRAINT FK_PN2;
ALTER TABLE CTPNSACH DROP CONSTRAINT FK_CTPNS1;
ALTER TABLE CTPNSACH DROP CONSTRAINT FK_CTPNS2;
...
ALTER TABLE SACH DROP CONSTRAINT CHECKSLHIECO;
ALTER TABLE NHAPHANPHOI DROP CONSTRAINT CHECK_SDTNPP;
...
----DROP TRIGGER
DROP TRIGGER CTPNSACH_INSERT_UPDATE;
DROP TRIGGER CTPNSACH_DELETE;
...
DROP PROCEDURE GETCTPNSACHTHEOMA;
DROP PROCEDURE GETMAPNS;
DROP PROCEDURE GETPNSTHEONPP;
DROP PROCEDURE THEMCTPNSACH;
DROP PROCEDURE THEMPNS;
