...
VALUES (SQ_TK.NEXTVAL, 'qly1', '123456', N'Nguy?n V?n A', '11-01-1999', N'43 Tân L?p, Ph??ng ?ông Hoà, D? An, Bình D??ng',  '0111111111', N'a@gmail.com',  '12-01-2019', N'Qu?n lý', 40000);

INSERT INTO TAIKHOAN(MATK, TENDN, MATKHAU, HOTEN, NGAYSINH, DIACHI, SDT, GMAIL, NGAYTAOTAIKHOAN, CHUCVU, LUONG) 
VALUES (SQ_TK.NEXTVAL, 'qly2', '654321', N'Tr?n Th? B', '11-03-1999', N'44 Tân L?p, Ph??ng ?ông Hoà, D? An, Bình D??ng',  '0111221111', N'b@gmail.com',  '12-01-2019', N'Qu?n lý', 45000);

INSERT INTO TAIKHOAN(MATK, TENDN, MATKHAU, HOTEN, NGAYSINH, DIACHI, SDT, GMAIL, NGAYTAOTAIKHOAN, CHUCVU, LUONG) 
VALUES (SQ_TK.NEXTVAL, 'nv1', '1234567', N'Hu?nh Th? C', '23-08-2003', N'45 Tân L?p, Ph??ng ?ông Hoà, D? An, Bình D??ng',  '0333333333', N'c@gmail.com',  '28-02-2022', N'Nhân viên', 22000);

INSERT INTO TAIKHOAN(MATK, TENDN, MATKHAU, HOTEN, NGAYSINH, DIACHI, SDT, GMAIL, NGAYTAOTAIKHOAN, CHUCVU, LUONG) 
VALUES (SQ_TK.NEXTVAL, 'nv2', '1234568', N'Lung Th? Linh', '03-05-2002', N'34 ???ng S? 12, Ph??ng Tr??ng Th?, Th? ??c, TP HCM',  '0122211111', N'linh@gmail.com',  '15-01-2021', N'Nhân viên', 25000);

INSERT INTO TAIKHOAN(MATK, TENDN, MATKHAU, HOTEN, NGAYSINH, DIACHI, SDT, GMAIL, NGAYTAOTAIKHOAN, CHUCVU, LUONG) 
VALUES (SQ_TK.NEXTVAL, 'nv3', '1234569', N'Lê V?n ?ô', '06-05-2002', N'43 ???ng S? 12, Ph??ng Tr??ng Th?, Th? ??c, TP HCM',  '0122211133', N'do@gmail.com',  '18-08-2021', N'Nhân viên', 25000);

INSERT INTO TAIKHOAN(MATK, TENDN, MATKHAU, HOTEN, NGAYSINH, DIACHI, SDT, GMAIL, NGAYTAOTAIKHOAN, CHUCVU, LUONG) 
VALUES (SQ_TK.NEXTVAL, 'nv4', '1234570', N'Tr?n V?n D', '06-08-1999', N'16 Lê V?n Vi?t, Q9, TP HCM',  '0123211133', N'D@gmail.com',  '18-08-2021', N'Nhân viên kho', 30000);

INSERT INTO TAIKHOAN(MATK, TENDN, MATKHAU, HOTEN, NGAYSINH, DIACHI, SDT, GMAIL, NGAYTAOTAIKHOAN, CHUCVU, LUONG) 
VALUES (SQ_TK.NEXTVAL, 'nv5', '1234670', N'?? V?n Nam', '06-10-1999', N'17 Nguy?n V?n T?ng, Q9, TP HCM',  '0123222233', N'nam@gmail.com',  '18-09-2021', N'K? toán', 30000);

--KHACHHANG
INSERT INTO KHACHHANG(MAKH, HOTEN, NGAYSINH, SDT, DIACHI, CCCD, GIOITINH)
VALUES (SQ_KH.NEXTVAL, N'Nguy?n A', '07-07-1980',  '0123456789', N'32 ???ng S? 3, Ph??ng Tr??ng Th?, Th? ??c, TP HCM ', '023456789111', N'Nam');

INSERT INTO KHACHHANG(MAKH, HOTEN, NGAYSINH, SDT, DIACHI, CCCD, GIOITINH)
VALUES (SQ_KH.NEXTVAL, N'Nguy?n B', '07-08-1980', '0124456789', N'32  ???ng S? 3, Ph??ng Tr??ng Th?, Th? ??c, TP HCM', '023456799111', N'N?');

INSERT INTO KHACHHANG(MAKH, HOTEN, NGAYSINH, SDT, DIACHI, CCCD, GIOITINH)
VALUES (SQ_KH.NEXTVAL, N'Lê C', '17-08-1985', '0124756789', N'14 ???ng S? 3, Ph??ng Tr??ng Th?, Th? ??c, TP HCM', '023456799222', N'N?');

INSERT INTO KHACHHANG(MAKH, HOTEN, NGAYSINH, SDT, DIACHI, CCCD, GIOITINH)
VALUES (SQ_KH.NEXTVAL, N'Tr?n Th? D', '20-06-1998', '0384756789', N'244 Nguy?n Th??ng Hi?n, Ph??ng 6, Qu?n Bình Th?nh, TP HCM', '044335274136', N'N?');

INSERT INTO KHACHHANG(MAKH, HOTEN, NGAYSINH, SDT, DIACHI, CCCD, GIOITINH)
VALUES (SQ_KH.NEXTVAL, N'Tr?n V?n D', '22-06-2002', '0358589888',  N'243A Nguy?n Th??ng Hi?n, Ph??ng 6, Qu?n Bình Th?nh, TP HCM', '053335274136', N'Nam');
...
(SQ_NPP.NEXTVAL, N'Nhà sách Ph??ng nam', N'272 Lê Thánh Tôn, Ph??ng B?n Nghé, Q1, TPHCM', '0914129286');

INSERT INTO NHAPHANPHOI(MANPP,TENNPP, DIACHI, SDT) VALUES
(SQ_NPP.NEXTVAL, N'Hi?u sách Nhã Nam', N'185 Hoa Lan, Ph??ng 2, Qu?n Phú Nhu?n, TPHCM', '0283847985');
...
INSERT INTO CHAMCONG(MATK, BATDAULAM, KETTHUC, SOGIOLAM) VALUES (1, '06-06-2023 08:00:00',  '06-06-2023 16:00:00', 8);
INSERT INTO CHAMCONG(MATK, BATDAULAM, KETTHUC, SOGIOLAM) VALUES (2, '06-06-2023 08:00:00',  '06-06-2023 16:00:00', 8);
INSERT INTO CHAMCONG(MATK, BATDAULAM, KETTHUC, SOGIOLAM) VALUES (3, '06-06-2023 08:00:00',  '06-06-2023 16:00:00', 8);
INSERT INTO CHAMCONG(MATK, BATDAULAM, KETTHUC, SOGIOLAM) VALUES (4, '06-06-2023 08:00:00',  '06-06-2023 16:00:00', 8);
INSERT INTO CHAMCONG(MATK, BATDAULAM, KETTHUC, SOGIOLAM) VALUES (5, '06-06-2023 08:00:00',  '06-06-2023 16:00:00', 8);
INSERT INTO CHAMCONG(MATK, BATDAULAM, KETTHUC, SOGIOLAM) VALUES (6, '06-06-2023 08:00:00',  '06-06-2023 16:00:00', 8);
...
INSERT INTO LUONG(MATK, THANG, NAM) VALUES (5, 2023, 5);
