...
END;
/
CREATE OR REPLACE PROCEDURE GETTLTHEOMA(mtl THELOAI.MATL, out_cur OUT SYS_REFCURSOR)
AS
BEGIN
       OPEN out_cur FOR 
        SELECT * FROM THELOAI
...
END;
/
CREATE OR REPLACE PROCEDURE GETTLTHEOTEN(mtl THELOAI.MATL, out_cur OUT SYS_REFCURSOR)
AS
BEGIN
       OPEN out_cur FOR 
        SELECT * FROM THELOAI
