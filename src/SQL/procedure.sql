...
--SACH
CREATE OR REPLACE PROCEDURE ThemSACH(ts IN SACH.TENSACH%TYPE, tg IN SACH.TENTG%TYPE, nxb IN SACH.NXB%TYPE, mtl IN SACH.MATL%TYPE, sl IN SACH.SLHIENCO%TYPE, anh IN SACH.ANHSACH%TYPE,  gia IN SACH.GIATIEN%TYPE)
AS
BEGIN 
...
END;
/
CREATE OR REPLACE PROCEDURE SuaSACH(ms SACH.MASACH%TYPE,ts IN SACH.TENSACH%TYPE, tg IN SACH.TENTG%TYPE, nxb IN SACH.NXB%TYPE, mtl IN SACH.MATL%TYPE, sl IN SACH.SLHIENCO%TYPE, anh IN SACH.ANHSACH%TYPE,  gia IN SACH.GIATIEN%TYPE)
AS
BEGIN 
        UPDATE SACH
        SET TENSACH = ts,
...
END;
/
CREATE OR REPLACE PROCEDURE XoaHD(mhd IN HOADON.MAHD%TYPE)
AS 
BEGIN
       DELETE FROM HOADON
       WHERE MAHD = mhd;
