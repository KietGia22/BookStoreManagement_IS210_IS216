...
END;
/
CREATE OR REPLACE PROCEDURE SuaTK(mtk TAIKHOAN.MATK%TYPE, hten TAIKHOAN.HOTEN%TYPE, ngsinh TAIKHOAN.NGAYSINH%TYPE,  dc TAIKHOAN.DIACHI%TYPE, sdt TAIKHOAN.SDT%TYPE, gmail TAIKHOAN.GMAIL%TYPE, cv TAIKHOAN.CHUCVU%TYPE, ngtao TAIKHOAN.NGAYTAOTAIKHOAN%TYPE, luong TAIKHOAN.LUONG%TYPE)
AS
BEGIN 
       UPDATE TAIKHOAN
       SET HOTEN = hten,
...
--KHACHHANG
CREATE OR REPLACE PROCEDURE ThemKH(hten KHACHHANG.HOTEN%TYPE, ngsinh KHACHHANG.NGAYSINH%TYPE,  dc KHACHHANG.DIACHI%TYPE, sdt KHACHHANG.SDT%TYPE, gtinh KHACHHANG.GIOITINH%TYPE, gc KHACHHANG.GHICHU%TYPE)
AS
BEGIN 
...
END;
/
CREATE OR REPLACE PROCEDURE SuaKH(mkh KHACHHANG.MAKH%TYPE, hten KHACHHANG.HOTEN%TYPE, ngsinh KHACHHANG.NGAYSINH%TYPE,  dc KHACHHANG.DIACHI%TYPE, sdt KHACHHANG.SDT%TYPE, gtinh KHACHHANG.GIOITINH%TYPE, gc KHACHHANG.GHICHU%TYPE)
AS
BEGIN 
       UPDATE KHACHHANG
       SET HOTEN = hten,
...
END;
/
CREATE OR REPLACE PROCEDURE GETSACHTHEOTL(ttl THELOAI.TENTHELOAI%TYPE, out_cur OUT SYS_REFCURSOR)
AS 
BEGIN 
     OPEN out_cur FOR 
     SELECT * FROM SACH 
